...
//которые удовлетвор€ют критерию равенства в функции compare2Skelets
...
//подсчитывает процентное содержани€ льда на снимке
float calculateIceContent (IplImage *src);

//строит ортогональную проекцию изображени€
